      ...
      <main className="flex-1 bg-white">
        ...
        <div className="prose-like space-y-6 text-sm text-[var(--color-text)] leading-relaxed">
          <Section title="Who we are">
            {SITE_NAME} is a used vehicle retailer based in Manchester. Our website address is:{" "}
            <span className="num">manchestercaryard.co.uk</span>
          </Section>
          ...
          <Section title="Your rights">
            <p>
              ...
              <a href={SITE_CONTACT.emailHref} className="text-[var(--color-accent)] hover:underline num">
                {SITE_CONTACT.email}
              </a>
              .
            </p>

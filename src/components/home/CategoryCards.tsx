...
export function CategoryCards() {
  return (
    <section
      className="relative hero-search-section-pad pb-12 bg-white"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {CATEGORIES.map(({ headline, description, href, bg, image, imageClass }) => (
            ...
            >
              ...
              {/* Copy — left */}
              <div className="relative z-10 flex h-full flex-col gap-3 pl-5 pr-16 py-6 sm:pl-6 sm:pr-8 sm:py-8 max-w-[58%] sm:max-w-[62%]">
